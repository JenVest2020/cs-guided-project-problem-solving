...
-iterate over the hash tables items extapolating the key and value of each item
...
def emotify(txt):
    ...
    # store the key value pairs of the required dta for swapping out the text to emoticons
    # we will store this data in a hash table (dictionary / object)
    data = {
        'smile': ':)',
        'grin': ':D',
    ...
    # get the data at 8 in from the start of the string [8: ] set is as end_of_string -> 'smile'
    end_of_string = txt[8: ]
